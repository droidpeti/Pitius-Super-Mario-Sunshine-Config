...
Add all the Gecko and AR codes found inside `Codes.md` to Dolphin.

Or copy my `GMSE01.ini` file to:

* **Windows**
    * Standard: `Documents\Dolphin Emulator\GameSettings\`
    * Modern: `%APPDATA%\Dolphin Emulator\GameSettings\`
* **Mac**
    * Path: `~/Library/Application Support/Dolphin/GameSettings/`
* **Linux**
    * Native: `~/.local/share/dolphin-emu/GameSettings/`
    * Flatpak: `~/.var/app/org.DolphinEmu.dolphin-emu/data/dolphin-emu/GameSettings/`

*Feel free to modify these to your liking in Dolphin.*

### 2. Disable the HUD
Copy the `/invisible_hud/GMSE01` folder from this repo into your Dolphin **Load/Textures** folder.

* **Windows**
    * Standard: `Documents\Dolphin Emulator\Load\Textures\`
    * Modern: `%APPDATA%\Dolphin Emulator\Load\Textures\`
* **Mac**
    * Path: `~/Library/Application Support/Dolphin/Load/Textures/`
* **Linux**
    * Native: `~/.local/share/dolphin-emu/Load/Textures/`
    * Flatpak: `~/.var/app/org.DolphinEmu.dolphin-emu/data/dolphin-emu/Load/Textures/`
...
**Technical Settings:**
* **Texture Pack:** No HUD by Sheldon Sharpe (Modified with a couple of missing textures)
